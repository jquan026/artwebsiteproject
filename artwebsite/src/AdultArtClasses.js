    ...
    <div className="AdultArtClass">
        ...
        <div className="about-classes">
            ...
            <ul>
                ...
                <li>Whether the student has previous experience with art or not, we can establish where you are and how you would like to continue to learn. We are able to and provide lessons in any of the mediums that we work within the studio.</li>
            </ul>
        </div>
        <div className='line-container'>
            <div className='line'></div>
